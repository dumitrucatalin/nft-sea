...
const SmartContractWallet = () => {
  ...
  const handleAllowance = async () => {
    try {
      if (!address) {
        console.error("Error: Please insert an address");
  ...
  return (
    <div className="p-5">
      <h1 className="mb-4 text-xl font-bold">SmartContractWallet (Sepolia {formatAddress(contractAddress)})</h1>
      ...
      <p className="mt-4 text-gray-500 break-words overflow-hidden max-width-500">
